    ...
    <section className="py-16 sm:py-24">
      <Container size="md">
        ...
        <AnimateIn preset="fade-up" delay={0.1}>
          <div className="rounded-2xl bg-white dark:bg-slate-900 shadow-sm border border-slate-100 dark:border-slate-800 p-6 sm:p-10 mb-8">
            {sent ? (
        ...
        <AnimateIn preset="fade-up" delay={0.15}>
          <p className="text-center text-sm text-slate-500 dark:text-slate-400 mb-20">
            {t("emailDirect")}{" "}
            <a
        ...
        <AnimateIn preset="fade-up" delay={0.2}>
          <div className="text-center mb-10">
            <h2 className="font-heading text-2xl font-bold sm:text-3xl tracking-tight text-slate-900 dark:text-white">
              {t("faqTitle")}
            </h2>
            <div className="mt-3 decorative-line-center" />
          </div>
